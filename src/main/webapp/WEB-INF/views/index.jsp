<%@ page import="com.wwj.order.util.SystemConstant" %>
<%@ page import="com.wwj.order.bean.Admin" %>
            ...
            <div id="userbox" class="userbox">
                ...
                <div class="dropdown-menu">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a role="menuitem" tabindex="-1" href="index/to/lock/page"><i class="fa fa-lock"></i> 锁定屏幕</a>
                        </li>
                        <li>
                            <a role="menuitem" tabindex="-1" href="admin/do/logout" id="a_logout"><i class="fa fa-power-off"></i> 注销</a>
                        </li>
                    </ul>
                </div>
            </div>
