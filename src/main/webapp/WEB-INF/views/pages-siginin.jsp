                ...
                <form action="admin/do/login" method="post">
                    <div class="form-group mb-lg">
                        ...
                        <div class="input-group input-group-icon">
                            <%-- 注册成功跳转登录页面后，回显注册信息 --%>
                            <input name="username" type="text" placeholder="${param.username}" class="form-control input-lg"/>
                    ...
                    <div class="form-group mb-lg">
                        <div class="clearfix">
                            ...
                            <a href="admin/to/forget/password/page" class="pull-right">忘记密码?</a>
                        </div>
                        <div class="input-group input-group-icon">
                            <input name="password" type="password" placeholder="${param.username}" class="form-control input-lg"/>
                            <span class="input-group-addon">
                                <span class="icon icon-lg">
                    ...
                    <p class="text-center">没有账户? <a href="admin/to/register/page">注册!</a>
